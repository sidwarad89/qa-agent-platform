...
export const AI_MODELS = [
  {
    ...
    steps: [
      ...
      'Paste it into the API Token field below. Anthropic\'s free trial credit is unreliable in 2026 — most accounts need billing added under "Plans & Billing" before it works.',
    ],
    versions: [
      { id: 'claude-haiku-4-5-20251001', label: 'Claude Haiku 4.5', free: false, bestFor: ['Fast responses', 'High-volume/cheap tasks'] },
      { id: 'claude-sonnet-5', label: 'Claude Sonnet 5', free: false, bestFor: ['Everyday coding', 'Balanced cost/speed', 'Agentic tasks'] },
      { id: 'claude-fable-5', label: 'Claude Fable 5', free: false, bestFor: ['Creative writing', 'Long-form content'] },
  ...
  },
  {
    ...
    steps: [
      ...
      'OpenAI no longer reliably gives free trial credit — most accounts need a payment method added under "Billing" before any request works, even a small one.',
    ],
    versions: [
      ...
      { id: 'gpt-4o', label: 'GPT-4o', free: false, bestFor: ['Multimodal (text+image)', 'Fast chat'] },
  ...
  },
  {
    ...
    steps: [
      ...
      'Copy the generated key (starts with AIza... or AQ...).',
      'Gemini has a genuinely free tier with rate limits — no card needed to start. Older model names (2.0/2.5 series) have been retired — use the current 3.x models below.',
    ],
    versions: [
      { id: 'gemini-3.6-flash', label: 'Gemini 3.6 Flash', free: true, bestFor: ['Fast + agentic', 'General purpose', 'Current default'] },
      { id: 'gemini-3.5-flash-lite', label: 'Gemini 3.5 Flash-Lite', free: true, bestFor: ['Cheapest', 'High-volume tasks'] },
      { id: 'gemini-3.1-flash-lite', label: 'Gemini 3.1 Flash-Lite', free: true, bestFor: ['Low latency', 'Frontier-class at low cost'] },
    ],
  },
  {
    id: 'mistral',
    ...
    steps: [
      ...
      'Mistral\'s free tier availability varies by account — check "Billing" in console if requests fail.',
    ],
    versions: [
      { id: 'mistral-large-2', label: 'Mistral Large 2', free: false, bestFor: ['Complex reasoning', 'Multilingual'] },
      { id: 'mistral-medium', label: 'Mistral Medium', free: false, bestFor: ['Balanced cost/quality'] },
      { id: 'codestral', label: 'Codestral', free: false, bestFor: ['Code generation', 'Code completion'] },
    ],
  },
  {
    id: 'xai',
    ...
    steps: [
      ...
      'Free starter credits are inconsistent — check "Billing" in console if requests fail.',
    ],
    versions: [
      { id: 'grok-4', label: 'Grok 4', free: false, bestFor: ['Reasoning', 'Real-time/current events'] },
      { id: 'grok-3-mini', label: 'Grok 3 Mini', free: false, bestFor: ['Fast + cheap', 'Simple tasks'] },
    ],
  },
  {
    id: 'groq',
  ...
  },
  {
    ...
    versions: [
      { id: 'deepseek-chat', label: 'DeepSeek-V3 (chat)', free: false, bestFor: ['General purpose', 'Very low cost'] },
      { id: 'deepseek-reasoner', label: 'DeepSeek-R1 (reasoner)', free: false, bestFor: ['Step-by-step reasoning', 'Coding'] },
    ],
  },
  {
    id: 'together',
  ...
  },
  {
    ...
    steps: [
      ...
      'Perplexity rarely gives reliable free trial credit anymore; expect to add billing before it works.',
    ],
    versions: [
      { id: 'sonar', label: 'Sonar', free: false, bestFor: ['Web-aware answers', 'Current events/research'] },
